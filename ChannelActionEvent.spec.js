...
function getProg_2() {
    let C = {
        ...
        eventAction_2_0: new ChannelActionEvent_1.ChannelActionEvent(chanVolume, env, "value + 1"),
        eventAction_2_2: new ChannelActionEvent_1.ChannelActionEvent(chanVolume, env, "value + 2"),
        eventAction_2_3: new ChannelActionEvent_1.ChannelActionEvent(chanVolume, env, "value + 3")
    };
...
describe("ChannelActionEvent: Program 2 initialization:", () => {
    ...
    it("c_child_event_2_0 => 100+1=101", () => {
        C.c_child_event_2_0.event.trigger({ value: true });
        Channel_1.commitStateActions();
        expect(C.Volume[0] === 101 && C.Volume.length === 4).toBe(true);
    });
