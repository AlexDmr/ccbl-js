...
describe("Serialization and deserialisztion to HumanReadableProgram is OK", () => {
    ...
    it("Actions are the same", () => {
        ...
        expect(ProgramObjectInterface_1.stateActionsEquivalents(originalActions, serializedActions, false)).toBe(true);
    });
    it("Allen are the same", () => {
        const originalAllens = rootProgDescr_2_copy.allen;
        const serializedAllens = progSerialization.allen;
        expect(ProgramObjectInterface_1.allenEquivalent(originalAllens, serializedAllens, false)).toBe(true);
    });
...
describe("Serialization and deserialisztion to HumanReadableProgram is OK", () => {
    ...
    it("domicubePlus actions OK", () => {
        const equi = ProgramObjectInterface_1.stateActionsEquivalents(DomicubeUsage_1.domicubePlus.actions, progSerialization.actions, false);
        expect(equi).toBe(true);
    });
    it("domicubePlus subPrograms OK", () => {
        const equi = ProgramObjectInterface_1.ProgramsEquivalents(DomicubeUsage_1.domicubePlus.subPrograms, progSerialization.subPrograms, false);
        expect(equi).toBe(true);
    });
    ...
    it("domicubePlus allenEquivalent OK", () => {
        const equi = ProgramObjectInterface_1.allenEquivalent(DomicubeUsage_1.domicubePlus.allen, progSerialization.allen, false);
        expect(equi).toBe(true);
    });
...
describe("Serialization and deserialisztion to EventInterpolation is OK", () => {
    ...
    it("actions OK", () => {
        const equi = ProgramObjectInterface_1.stateActionsEquivalents(originalProg.actions, progSerialization.actions, false);
        expect(equi).toBe(true);
    });
    it("subPrograms OK", () => {
        const equi = ProgramObjectInterface_1.ProgramsEquivalents(originalProg.subPrograms, progSerialization.subPrograms, false);
        expect(equi).toBe(true);
    });
    it("dependencies OK", () => {
    ...
    it("allenEquivalent OK", () => {
        const equi = ProgramObjectInterface_1.allenEquivalent(originalProg.allen, progSerialization.allen, false);
        expect(equi).toBe(true);
    });
