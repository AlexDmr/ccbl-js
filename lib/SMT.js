...
function getContextSMTdescrFromProg(P) {
    ...
    str += canActivateAndDesactivate(P, Object.assign({ state: 'true', contextName: 'program root' }, P), []);
    return str;
}
...
function canActivateAndDesactivate(P, C, ancestorActions) {
    ...
    str += `(pop)\n`;
    const LC = [
        ...getStateContextsFrom((_a = C.allen) === null || _a === void 0 ? void 0 : _a.During),
        ...getStateContextsFrom((_b = C.allen) === null || _b === void 0 ? void 0 : _b.StartWith),
        ...getStateContextsFrom((_c = C.allen) === null || _c === void 0 ? void 0 : _c.EndWith)
    ];
    console.log('LC:', LC);
    str += LC.map(context => canActivateAndDesactivate(P, context, actions)).join(`\n`);
    str += getStateContextsFrom((_e = (_d = C === null || C === void 0 ? void 0 : C.allen) === null || _d === void 0 ? void 0 : _d.Meet) === null || _e === void 0 ? void 0 : _e.contextsSequence).map(context => canActivateAndDesactivate(P, context, ancestorActions)).join(`\n`);
    return str;
}
