...
exports.initChannelActionEvent = exports.ChannelActionEvent = void 0;
...
class ChannelActionEvent extends ChannelAction_1.ChannelAction {
    ...
    toJSON() {
        if (this.jsonDirty.get()) {
            ...
            return this.lastJSON = Object.assign(Object.assign({}, super.toJSON()), { type: typeJSON, expression: this.exprInEnv.originalExpression });
        }
        else {
...
function initChannelActionEvent() {
...
exports.initChannelActionEvent = initChannelActionEvent;
