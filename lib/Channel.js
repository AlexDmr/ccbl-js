...
exports.Desactivate = exports.Activate = exports.createChannel = exports.registerChannel = exports.commitStateActions = exports.UpdateChannelsActions = exports.Channel = exports.getNewChannel = void 0;
...
class Channel {
    ...
    configChanged() {
        ...
        return !oC
            ...
            || nC.stateConstraints.reduce((acc, sc, i) => {
                return acc || sc !== (oC === null || oC === void 0 ? void 0 : oC.stateConstraints[i]);
            }, false)
            || nC.channelActionEvents.length !== oC.channelActionEvents.length
            || nC.channelActionEvents.reduce((acc, sc, i) => {
                return acc || sc !== (oC === null || oC === void 0 ? void 0 : oC.channelActionEvents[i]);
            }, false);
    }
    ...
    ListenToContextEvents() {
        var _a;
        (_a = this.lastActiveStateConfig) === null || _a === void 0 ? void 0 : _a.channelActionEvents.forEach(cae => {
            let conf = {
    ...
    overhideValue(newValue) {
        var _a;
        (_a = this.lastActiveStateConfig) === null || _a === void 0 ? void 0 : _a.channelActionState.overrideWith(newValue);
        this.forceCommit = true;
        this.commit();
        return this;
    }
    ApplyConstraintsToValue(original) {
        var _a, _b;
        let res;
        let stateConstraints = (_b = (_a = this.lastActiveStateConfig) === null || _a === void 0 ? void 0 : _a.stateConstraints) !== null && _b !== void 0 ? _b : [];
