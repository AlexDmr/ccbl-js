...
class CCBLEvent {
    constructor({ eventExpression, eventName, expressionFilter, env, eventerSourceId }) {
        ...
        this.setGuardExpression(expressionFilter !== null && expressionFilter !== void 0 ? expressionFilter : "");
        if (eventerSourceId) {
    ...
    toJSON() {
        ...
        if (this.jsonDirty.get()) {
            ...
            this.lastJSON = {
                ...
                type: typeJSON,
                eventExpression: (_a = this.eventExpression) !== null && _a !== void 0 ? _a : "",
    ...
    getGuardExpression() {
        var _a, _b;
        return (_b = (_a = this.expreInEnv) === null || _a === void 0 ? void 0 : _a.getExpression()) !== null && _b !== void 0 ? _b : "";
    }
