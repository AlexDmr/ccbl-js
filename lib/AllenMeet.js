...
exports.initMeet = exports.CCBLAllenMeet = void 0;
...
function initMeet() {
    Serialiser_1.registerUnserializer("Meet", ((json, env) => {
        return new CCBLAllenMeet(undefined, json.children.map(Cjson => Serialiser_1.Unserialize(Cjson, env)));
    }));
}
exports.initMeet = initMeet;
