...
exports.CCBLProgramObject = void 0;
...
class CCBLProgramObject {
    ...
    getEmitter(id, env) {
        ...
        if (emitter) {
            ...
            return channel === null || channel === void 0 ? void 0 : channel.getValueEmitter();
        }
    }
    ...
    getProgramInstance(instanceName) {
        ...
        for (let progId of this.subPrograms.keys()) {
            const progInstance = (_a = this.subPrograms.get(progId)) === null || _a === void 0 ? void 0 : _a.instances.find(P => P.as === instanceName);
            if (progInstance) {
    ...
    unplugSubProgramInstance(instanceName) {
        for (let progId of this.subPrograms.keys()) {
            ...
            const progInstance = SPD === null || SPD === void 0 ? void 0 : SPD.instances.find(P => P.as === instanceName);
            if (progInstance) {
    ...
    removeSubProgram(programId) {
        ...
        if (this.subPrograms.has(programId)) {
            (_a = this.subPrograms.get(programId)) === null || _a === void 0 ? void 0 : _a.instances.forEach(P => P.prog.dispose());
    ...
    plugSubProgramAs(config) {
        ...
        const { description: subProgamDescription, instances: subProgramInstances } = (_a = this.subPrograms.get(programId)) !== null && _a !== void 0 ? _a : { description: {}, instances: [] };
        ...
        const allenRel = Serialiser_1.Unserialize(jsonAllen, ExecutionEnvironment_1.emptyEnvExec);
            ...
            switch (context.getType()) {
                case "CCBLContextState":
                    ...
                    if (rootOfProgramId) {
                        ...
                        return ProgramObjectInterface_1.copyProgRef({
    ...
    loadHumanReadableProgram(descr, env, mapInputs) {
        ...
        emittersImport
            ...
            if (emitter) {
                ...
                const expr = new CCBLExpressionInExecutionEnvironment_1.CCBLExpressionInExecutionEnvironment({ env, expression: exprStr !== undefined ? exprStr : name });
        ...
        eventsImport
            ...
            if (eventer) {
                ...
                if (eventTrigger.eventSource !== undefined) {
                    const evt = new Event_1.CCBLEvent({
    ...
    loadContextOrProgram(allen, hostContext, descr) {
        ...
        if (progRef.programId) {
            const SP = this.plugSubProgramAs({
                ...
                as: progRef.as,
                mapInputs: (_a = progRef.mapInputs) !== null && _a !== void 0 ? _a : {},
                allen: allen,
    ...
    loadHumanReadableContextState(descr, context) {
        if (context === undefined) {
            ...
            context = new ContextState_1.CCBLContextState({ ...contextConfig, contextName: descr.contextName });
    ...
    createLocalChannelsFromVars(...vars) {
        const L = vars.map(({ name, type }) => {
            const channel = Channel_1.getNewChannel(undefined);
    ...
    createLocalEventerFromVars(...vars) {
        const L = vars.map(({ name, type }) => {
            const eventer = new Event_1.CCBLEvent({ eventName: name, env: this.getEnvironment() });
    ...
    getSubProgramIdentifiedBy(instanceName) {
        ...
        for (const progName of progNames) {
            ...
            const instance = descr === null || descr === void 0 ? void 0 : descr.instances.find(inst => inst.as === instanceName);
            if (instance) {
                return {
                    ...instance,
