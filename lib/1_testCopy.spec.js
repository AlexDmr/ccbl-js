...
describe("Copy Domicube -> actions", () => {
    it("copy is OK", () => {
        const actions = domicube.actions.map(a => copyHumanReadableStateActions(a));
...
describe("Copy Domicube", () => {
    it("copy is OK", () => {
        const copyDomicube = copyHumanReadableProgram(domicube);
...
describe("Copy domicubePlus", () => {
    it("copy is OK", () => {
        const copydomicubePlus = copyHumanReadableProgram(domicubePlus);
