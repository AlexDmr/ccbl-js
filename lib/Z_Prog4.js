...
exports.initProgExo4Env = exports.ProgExo4 = exports.EnvDescr4 = exports.ProgExo4State = exports.MartinLocation = exports.AliceAvailability = exports.AliceLocation = exports.LAMP_chan = exports.LAMP_valueEmitter = exports.envExo4 = exports.clock = void 0;
...
exports.ProgExo4 = new ContextState_1.CCBLContextState({
...
}).appendChannelActions(new ChannelActionState_1.ChannelActionState(exports.LAMP_chan, exports.envExo4, `"OFF"`)).appendParentOfAllenRelationships(new AllenDuring_1.CCBLAllenDuring(undefined, [
    new ContextState_1.CCBLContextState({
    ...
    }).appendParentOfAllenRelationships(new AllenDuring_1.CCBLAllenDuring(undefined, [
        new ContextState_1.CCBLContextState({
            environment: exports.envExo4,
            contextName: "pipo",
            state: new StateInExecutionEnvironment_1.CCBLStateInExecutionEnvironment({
        ...
        }).appendChannelActions(new ChannelActionState_1.ChannelActionState(exports.LAMP_chan, exports.envExo4, `"ORANGE"`)).appendParentOfAllenRelationships(new AllenDuring_1.CCBLAllenDuring(undefined, [
            new ContextState_1.CCBLContextState({
                environment: exports.envExo4,
                contextName: "pipo",
                state: new StateInExecutionEnvironment_1.CCBLStateInExecutionEnvironment({
