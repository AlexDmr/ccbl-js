...
describe("ProgramObject: Loading of programs:", () => {
    ...
    it("instanciate correctly childProg under subProgRootFirst", () => {
        ...
        Channel_1.commitStateActions();
        const expectedP = Object.assign(Object.assign({}, ProgramObjectInterface_1.copyHumanReadableProgram(rootProgLoadUnload_1.rootProg)), { subPrograms: {
                childProg: rootProgLoadUnload_1.childProg
            } });
    ...
    it("uninstanciate correctly childProg1", () => {
        ...
        Channel_1.commitStateActions();
        const actualP = prog.toHumanReadableProgram();
        const expectedP = Object.assign(Object.assign({}, actualP), { subPrograms: {
                childProg: rootProgLoadUnload_1.childProg
            } });
        expectedP.allen = {
            During: [...expectedP.allen.During]
        };
        expectedP.allen.During[2] = Object.assign({}, expectedP.allen.During[2]);
        expectedP.allen.During[2].allen = {
            During: [{
                    programId: "childProg",
                    as: "childProg2",
