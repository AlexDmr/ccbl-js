...
import { domicubeUsage2 } from "./DomicubeUsage2";
describe("The Domicube usage 2", () => {
    ...
    sourceEnv.register_Channel("Volume", Volume);
    ...
    it("should have the correct initial values", () => {
        rootProg.loadHumanReadableProgram(domicubeUsage2, sourceEnv, {});
    ...
    it("should be able to reload the very same program", () => {
        ...
        console.log("P1/P2:", domicubeUsage2, P2);
        expect(progEquivalent(domicubeUsage2, P2, false)).toEqual(true);
    });
...
//# sourceMappingURL=DomicubeUsage2.spec.js.map