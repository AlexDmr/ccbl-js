...
exports.updateDependencies = exports.isItPossibleToAddDependency = exports.getAllDependencies = void 0;
...
const pipoEmitter = new EmitterValue_1.CCBLEmitterValue(undefined);
function isItPossibleToAddDependency(target, dependencies) {
    let result = true;
    try {
...
exports.isItPossibleToAddDependency = isItPossibleToAddDependency;
