...
const emitterVarAlpha = new EmitterValue_1.CCBLEmitterValue(0);
...
function getProg_3() {
    let C = {
        ...
        eventAction_2_0: new ChannelActionEvent_1.ChannelActionEvent(chanVarAlpha, env, "chanVarAlpha + 1"),
        eventAction_2_2: new ChannelActionEvent_1.ChannelActionEvent(chanVarAlpha, env, "chanVarAlpha + 2"),
        eventAction_2_3: new ChannelActionEvent_1.ChannelActionEvent(chanVarAlpha, env, "chanVarAlpha + 3")
    };
