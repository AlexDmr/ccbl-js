    ...
    setExpression(expression, scope = []) {
        ...
        if (this.exprRootNode.type === "BlockNode") {
            ...
            if (L.length === 4) {
                ...
                this.exprInterpolation = { V0, V1, duration, interpolator, T0: undefined, dtFct: exports.mathjs.compile("(ms - T0) / duration") };
            }
        }
    ...
    listen(value = true) {
        ...
        if (this.listening) {
            ...
            if (this.exprInterpolation) {
                ...
                this.nextUpdateTime = this.exprInterpolation.T0 + duration_value;
