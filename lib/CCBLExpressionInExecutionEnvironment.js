...
export const scopeInterpolator = {
...
export class CCBLExpressionInExecutionEnvironment extends CCBLEmitterValue {
    constructor(config) {
        super(undefined);
        this._variableNames = [];
    ...
    toJSON() {
        ...
        return {
            ...super.toJSON(),
            type: typeJSON,
            expression: (_a = this.getExpression()) !== null && _a !== void 0 ? _a : '',
            originalExpression: this._originalExpression
        };
    }
    getErrorEvaluation() {
    ...
    getExpression() {
        var _a;
        return (_a = this.exprRootNode) === null || _a === void 0 ? void 0 : _a.toString();
    }
    setExpression(expression, scope = []) {
        ...
        if (this.exprRootNode.type === "BlockNode") {
            ...
            if (L.length === 4) {
                ...
                const cbExprTime = (t) => {
                    if (!isNaN(t !== null && t !== void 0 ? t : NaN)) {
                ...
                this.exprInterpolation = {
                    ...
                    dtFct: mathjs.compile("(ms - T0) / duration"),
                    exprDuration,
                    cbExprTime
                };
            }
        ...
        updateDependencies(undefined, this, this.getAllDependencies());
    ...
    listen(value = true) {
        ...
        if (this.listening) {
            if (this.neverListenBefore) {
                ...
                this.setExpression((_a = this.getExpression()) !== null && _a !== void 0 ? _a : '');
            }
            if (this.exprInterpolation) {
                ...
                const duration_value = mathjs.evaluate(this.exprInterpolation.duration, this.getScope());
    ...
    instanciate(scope = {}) {
        ...
        (_a = this.env.getAllProgramInstance()) === null || _a === void 0 ? void 0 : _a.forEach(({ id, progVar }) => {
            const obj = {};
            scope[id] = obj;
        ...
        if (this.exprInterpolation) {
            ...
            const duration_value = mathjs.evaluate(duration, scope);
            const V0_value = mathjs.evaluate(V0, scope);
            const V1_value = mathjs.evaluate(V1, scope);
            return `${V0_value}; ${V1_value}; ${duration_value}; ${interpolator}`;
        }
        else {
            return JSON.stringify((_b = this.exprRootNode) === null || _b === void 0 ? void 0 : _b.evaluate(scope));
        }
    }
    forceEvaluationOnce(addedScope = {}, logError = false) {
        ...
        try {
            if (this.exprInterpolation) {
                ...
                if (dt_value >= 1) {
                    res = mathjs.evaluate(V1, scope);
                    this.env.get_Clock().offChange(this.cbEmitterUpdated);
                }
                else {
                    const V0_value = mathjs.evaluate(V0, scope);
                    const V1_value = mathjs.evaluate(V1, scope);
                    res = mathjs.evaluate(`${interpolator} (${dt_value}, ${V0_value}, ${V1_value} )`, scopeInterpolator);
                }
            }
            else {
                res = (_b = this.exprRootNode) === null || _b === void 0 ? void 0 : _b.evaluate(scope);
            }
            this.errorEvaluation = undefined;
        }
        catch (err) {
            if (logError) {
                console.error("CCBLExpressionInExecutionEnvironment::forceEvaluationOnce ERROR:\n", (_c = this.exprRootNode) === null || _c === void 0 ? void 0 : _c.toString(), "\n", err);
            }
            res = undefined;
