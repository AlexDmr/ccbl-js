...
export function contextEquivalent(A, B, withId) {
    ...
    if (stateContextA.type === "STATE") {
        ...
        const stateA = (_c = stateContextA.state) !== null && _c !== void 0 ? _c : "true";
        const stateB = (_d = stateContextB.state) !== null && _d !== void 0 ? _d : "true";
        const result = stateA === stateB
            && (!withId || (stateContextA.id === stateContextB.id))
            && stateContextA.contextName === stateContextB.contextName
            && stateActionsEquivalents((_e = stateContextA.actions) !== null && _e !== void 0 ? _e : [], (_f = stateContextB.actions) !== null && _f !== void 0 ? _f : [], withId)
            && eventActionsEquivalent((_g = stateContextA.actionsOnStart) !== null && _g !== void 0 ? _g : [], (_h = stateContextB.actionsOnStart) !== null && _h !== void 0 ? _h : [], withId)
            && eventActionsEquivalent((_j = stateContextA.actionsOnEnd) !== null && _j !== void 0 ? _j : [], (_k = stateContextB.actionsOnEnd) !== null && _k !== void 0 ? _k : [], withId)
            ...
            && allenEquivalent((_l = stateContextA.allen) !== null && _l !== void 0 ? _l : {}, (_m = stateContextB.allen) !== null && _m !== void 0 ? _m : {}, withId);
        return result;
    }
