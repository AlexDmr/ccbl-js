...
function contextsMeetEquivalent(A, B, withId) {
    ...
    return CMA.contextsSequence.length === CMA.contextsSequence.length &&
        (CMA.contextsSequence.length === 0
            || (CMA.loop === CMB.loop && contextsEquivalent(CMA.contextsSequence, CMB.contextsSequence, withId)));
}
...
function copyAllen(allen, withCcblRef = true) {
    ...
    if (((_b = (_a = allen.Meet) === null || _a === void 0 ? void 0 : _a.contextsSequence) === null || _b === void 0 ? void 0 : _b.length) > 0) {
        copy.Meet = {
