...
exports.CCBLEventAnd = void 0;
const Event_1 = require("./Event");
class CCBLEventAnd extends Event_1.CCBLEvent {
    constructor(eventName = "AND", env, msDelay, fctAND) {
        super({ eventName, env });
    ...
    trimEvents() {
        ...
        for (let c of this.children) {
            ...
            if (pos >= 0) {
                consummedEvents.push(events.splice(pos, 1)[0]);
            }
            else {
                return;
            }
...
exports.CCBLEventAnd = CCBLEventAnd;
//# sourceMappingURL=EventAnd.js.map