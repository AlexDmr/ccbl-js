    ...
    updateActive(value) {
        ...
        if (value !== this.active) {
            ...
            if (this.active) {
                ...
                if (this.eventStart && this.eventFinish
                    && this.eventStart.getEventerSourceId() === this.eventFinish.getEventerSourceId()
                    && this.eventStart.getGuardExpression() === this.eventFinish.getGuardExpression()
                    && this.eventStart.getEventExpression() === this.eventFinish.getEventExpression()
                    && this.eventStart.getEventName() === this.eventFinish.getEventName()) {
                    this.eventStart.off(this.cbEventStart);
                }
            }
            else {
