...
export class CCBLEnvironmentExecution {
    constructor(clock, contextOrder = StructuralOrder) {
        this.clock = clock;
    ...
    getAllEventers() {
        return Array.from(this.mapEvents.values());
    }
    getAllEmitterValues() {
...
export const emptyEnvExec = new CCBLEnvironmentExecution(new CCBLTestClock());
