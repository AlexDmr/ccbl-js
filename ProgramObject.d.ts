...
export declare class CCBLProgramObject implements CCBLProgramObjectInterface {
    ...
    private createLocalEmitter(...emitters);
    private loadContextOrProgram(allen, hostContext, descr);
    private loadHumanReadableContext(descr);
    private loadHumanReadableContextevent(descr);
    private loadHumanReadableContextState(descr, context?);
    private getRootContext();
    private createLocalChannels(...channels);
