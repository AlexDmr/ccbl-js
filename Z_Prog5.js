...
exports.ProgExo5 = new ContextState_1.CCBLContextState({
    ...
    }).appendChannelActions(new ChannelActionState_1.ChannelActionState(exports.TV_volume, exports.envExo5, "chanVarBeta"), new ChannelActionState_1.ChannelActionState(exports.chanVarBeta, exports.envExo5, "50")).appendParentOfAllenRelationships(new AllenDuring_1.CCBLAllenDuring(null, [
        new ContextEvent_1.CCBLContextEvent(exports.TV_evtVolP).appendChannelActions(new ChannelActionEvent_1.ChannelActionEvent(exports.chanVarBeta, exports.envExo5, "value + 1")),
        new ContextEvent_1.CCBLContextEvent(exports.TV_evtVolM).appendChannelActions(new ChannelActionEvent_1.ChannelActionEvent(exports.chanVarBeta, exports.envExo5, "value - 1")),
        new ContextEvent_1.CCBLContextEvent(exports.TV_evtChanP).appendChannelActions(new ChannelActionEvent_1.ChannelActionEvent(exports.TV_channel, exports.envExo5, "value + 1")),
        new ContextEvent_1.CCBLContextEvent(exports.TV_evtChanM).appendChannelActions(new ChannelActionEvent_1.ChannelActionEvent(exports.TV_channel, exports.envExo5, "value - 1")),
    ])),
    new ContextState_1.CCBLContextState({
        environment: exports.envExo5,
        state: new StateInExecutionEnvironment_1.CCBLStateInExecutionEnvironment({
